...
def predict_single_version(version, numeric_test, model_root, output_root, window_size=24):
    ...
    with open(summary_path, "w", encoding="utf-8") as f:
        ...
        f.write("test_source: data/wind_train_val_2012-01-02_to_2013-07-13.npy (last 20% by time)\n")
...
def main():
    ...
    parser.add_argument(
        ...
        help="原始数据路径，脚本会自动取后20%时间段作为测试段",
    )
    parser.add_argument(
        "--versions",
        type=str,
