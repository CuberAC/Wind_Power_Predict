...
def load_data_for_tuning(data_path='features_v3_lite.npz', target_farm_id=0):
    """
...
def main():
    # 1. 准备数据 (这里默认用 features_v3_lite.npz，用 Farm 0 试水)
    load_data_for_tuning('features_v3_lite.npz', target_farm_id=0)
